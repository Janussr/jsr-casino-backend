...
namespace PokerProject.Migrations
{
    ...
    [Migration("20260302145836_addKnockoutuserToscore")]
    partial class addKnockoutuserToscore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Score", b =>
                {
                    ...
                    b.Property<int?>("KnockedOutUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Score", b =>
                {
                    ...
                    b.HasOne("PokerProject.Models.User", "KnockedOutUser")
                        .WithMany()
                        .HasForeignKey("KnockedOutUserId");
